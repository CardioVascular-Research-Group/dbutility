...
//import edu.jhu.cvrg.waveform.utility.ParameterOption;
//import edu.jhu.cvrg.waveform.utility.ParameterValidator;
...
public class AdditionalParameters implements Serializable{
	...
	* https://bitbucket.org/galaxy/galaxy-central/src/tip/lib/galaxy/tools/parameters/basic.py  */
	...
	public void setParameterFlag(String sParameterFlag) {
		this.sParameterFlag = sParameterFlag;
	}
	public String getParameterDefaultValue() {
		return sParameterDefaultValue;
	}
	public void setParameterDefaultValue(String sParameterDefaultValue) {
		this.sParameterDefaultValue = sParameterDefaultValue;
	}
	public String getParameterUserSpecifiedValue() {
		return sParameterUserSpecifiedValue;
	}
	public void setParameterUserSpecifiedValue(String sParameterUserSpecifiedValue) {
	...
	public ParameterOption[] getOptionList() {
		return aOptionList;
	}
	public void setOptionList(ParameterOption[] aOptionList) {
